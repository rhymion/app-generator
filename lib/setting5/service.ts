...
export async function addSetting5(creatorId: string, name: string, email: string) {
...
export async function updateSetting5(id: string, name: string, email: string, srcSnapshotRaw?: string | null) {
