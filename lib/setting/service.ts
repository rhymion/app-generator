...
export async function addSetting(creatorId: string, name: string, email: string) {
...
export async function updateSetting(id: string, name: string, email: string, srcSnapshotRaw?: string | null) {
...
export async function deleteSetting(ids: string[]) {
  if (ids.length === 1) {
