...
export async function updateSetting(actorId: string, id: string, name: string, email: string, password: string | null, apiKey: string | null, image: string | null, rolesIds: string[], srcSnapshotRaw: string | null): Promise<void> {
