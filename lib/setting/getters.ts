...
const SORTABLE_FIELDS = new Set<string>(['id', 'name', 'email', 'password', 'api_key', 'image', 'created_at', 'updated_at', 'creator_id']);
const FILTERABLE_FIELDS = new Set<string>(['id', 'name', 'email', 'password', 'api_key', 'image', 'created_at', 'updated_at', 'creator_id']);
