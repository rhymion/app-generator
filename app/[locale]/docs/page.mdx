...
|--------|-----------|:---:|:-----:|--------|
| [Db Table](db_table) | List · View · Create · Update · Delete | ✓ |  | [→](db_table) |
| [Xxxxx Xxxxx](xxxxx_xxxxx) | List · View · Create · Update · Delete | ✓ |  | [→](xxxxx_xxxxx) |
| [Parent1](parent1) | List · View · Create · Update · Delete | ✓ |  | [→](parent1) |
| [Parent Only](parent_only) | List · View · Create · Update · Delete | ✓ |  | [→](parent_only) |
| [User Account](user_account) | List · View · Update · Delete | ✓ |  | [→](user_account) |
| [Setting](setting) | List · View · Update | ✓ |  | [→](setting) |
| [Setting1](setting1) | List · View · Create · Update · Delete | ✓ |  | [→](setting1) |
| [Setting2](setting2) | List · View · Create |  |  | [→](setting2) |
| [Setting3](setting3) | List · Update · Delete |  |  | [→](setting3) |
| [Setting4](setting4) | List | ✓ |  | [→](setting4) |
| [Setting5](setting5) | View · Update | ✓ |  | [→](setting5) |
| [Setting6](setting6) | View · Delete |  |  | [→](setting6) |
| [Setting7](setting7) | Create · Update |  |  | [→](setting7) |
| [Setting8](setting8) | Create · Delete | ✓ |  | [→](setting8) |
| [Role](role) | List · View · Create · Update · Delete | ✓ |  | [→](role) |
| [Organization](organization) | List · View · Create · Update · Delete | ✓ |  | [→](organization) |
| [Permission](permission) | List · View · Create · Update · Delete | ✓ |  | [→](permission) |
| [Procedure](procedure) | List · View · Create · Update · Delete | ✓ |  | [→](procedure) |
| [Resource](resource) | List · View · Create · Update · Delete | ✓ |  | [→](resource) |
| [Booking](booking) | List · View · Create · Update · Delete | ✓ | ✓ | [→](booking) |
| [Shift Template](shift_template) | List · View · Create · Update · Delete | ✓ |  | [→](shift_template) |
| [Shift](shift) | List · View · Create · Update · Delete | ✓ | ✓ | [→](shift) |
| [Product](product) | List · View · Create · Update · Delete | ✓ |  | [→](product) |
| [Inventory](inventory) | List · View · Create · Update · Delete | ✓ |  | [→](inventory) |
| [Purchase Order](purchase_order) | List · View · Create · Update · Delete | ✓ |  | [→](purchase_order) |
