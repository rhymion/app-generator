...
| `parent_id` | `string \| null` |  |  | FK → [procedure](../procedure) (label: `name`), CUID |
| `assignee_id` | `string \| null` |  |  | FK → [user_account](../user_account) (label: `name`), CUID |
...
|-----------------|---------------|-------------------|
| `parent_id` | [`procedure`](../procedure) | many-to-one |
| `assignee_id` | [`user_account`](../user_account) | many-to-one |
| `children` | [`procedure`](../procedure) | one-to-many · `list` |
| `preceded_by` | [`procedure`](../procedure) | many-to-many · `list` |
| `followed_by` | [`procedure`](../procedure) | many-to-many · `list` |
