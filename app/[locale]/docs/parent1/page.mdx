...
| `parent1_child1s` | [`parent1_child1`](../parent1_child1) | one-to-many |
| `parent1_child2s` | [`parent1_child2`](../parent1_child2) | one-to-many |
| `parent1_lists` | [`parent1_list`](../parent1_list) | one-to-many · `list` |
