...
export async function GET(request: NextRequest, { params }: Params) {
  try {
    ...
    await requireApiPermission(actorId, 'organization', 'read', item);
...
export async function PUT(request: NextRequest, { params }: Params) {
  try {
    ...
    await requireApiPermission(actorId, 'organization', 'update', existing);
...
export async function DELETE(request: NextRequest, { params }: Params) {
  try {
    ...
    await requireApiPermission(actorId, 'organization', 'delete', existing);
