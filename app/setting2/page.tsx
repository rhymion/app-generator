...
import { removeSetting2 } from '@/lib/setting2/actions';

export default async function Setting2sPage() {
  const { setting2s, userPermissions } = await getSetting2ListPageData();
  return <DataGridClient src={setting2s} basePath="/setting2" removeAction={removeSetting2} entityLabel="Setting2" displayFields={[
