---
description: Add or update a UI component — build + component tests + e2e API gate + eslint.
argument-hint: <component name or description>
---

This is an **add-component** task. Read CLAUDE.md before starting.
...
3. `npm run test:e2e:build`  — docker:up:test + generate-code + db:push + db:generate + db:seed-baseline + build
