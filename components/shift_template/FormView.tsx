  ...
  return (
    <div>
      ...
      <TextField
        ...
        aria-readonly
      />
      <DateTimeWrapper label="Start Time" date_time={src.start_time} show_date={false} readOnly />
      <DateTimeWrapper label="End Time" date_time={src.end_time} show_date={false} readOnly />
      <AuditInfo src={src} />
    </div>
  );
}
