...
const API_BASE = '/api/fc_link';

describe('API: Fc Link', () => {
  beforeEach(() => {
    cy.task('db:reset');
    cy.task('db:seed');
  ...
  describe('DELETE /api/fc_link/:id', () => {
  ...
  describe('DELETE /api/fc_link/bulk', () => {
  ...
  describe('Permission errors', () => {
    it('7.1 returns 4xx for GET list when permission denied', () => {
      cy.task<string>('db:createLimitedApiUser', 'fc_link').then((limitedKey) => {
