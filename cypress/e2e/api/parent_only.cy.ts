...
const API_BASE = '/api/parent_only';

describe('API: Parent Only', () => {
  beforeEach(() => {
    cy.task('db:reset');
    cy.task('db:seed');
  });

  describe('GET /api/parent_only', () => {
  ...
  describe('GET /api/parent_only/:id', () => {
  ...
  describe('PUT /api/parent_only/:id', () => {
  ...
  describe('DELETE /api/parent_only/:id', () => {
  ...
  describe('POST /api/parent_only/bulk', () => {
  ...
  describe('PUT /api/parent_only/bulk', () => {
  ...
  describe('DELETE /api/parent_only/bulk', () => {
  ...
  describe('Permission errors', () => {
    it('7.1 returns 403 for GET list when permission denied', () => {
      cy.task<string>('db:createLimitedApiUser', 'parent_only').then((limitedKey) => {
