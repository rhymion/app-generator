...
describe('API: Purchase Order', () => {
  beforeEach(() => {
    cy.task('db:reset');
    cy.task('db:seed');
  });

  describe('GET /api/purchase_order', () => {
  ...
  describe('GET /api/purchase_order/:id', () => {
  ...
  describe('PUT /api/purchase_order/:id', () => {
  ...
  describe('DELETE /api/purchase_order/:id', () => {
  ...
  describe('POST /api/purchase_order/bulk', () => {
  ...
  describe('PUT /api/purchase_order/bulk', () => {
  ...
  describe('DELETE /api/purchase_order/bulk', () => {
