...
describe('Testing Permission pages and their behavior', () => {
  ...
  describe('Display list', () => {
    it('1.1 shows 6 seed-only item(s) before any user data', () => {
      ...
      getDataGridTotalRowCount().should('eq', 6);
    });
    ...
    it('1.2 shows list with one item', () => {
      ...
      getDataGridTotalRowCount().should('eq', 7);
    });
    ...
    it('1.3 shows list with multiple items', () => {
      ...
      getDataGridTotalRowCount().should('eq', 9);
    });
  });
