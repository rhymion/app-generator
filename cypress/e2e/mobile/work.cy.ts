...
//
// Mobile-viewport spec (Work). The list page renders a different
...
describe('Testing Work pages and their behavior [mobile]', () => {
  beforeEach(() => {
  ...
  describe('Create from card list', () => {
    it('2.1 navigates to the new page via the toolbar add button', () => {
      ...
      // aria-label as the desktop variant ("Create New Work").
      cy.get('button[aria-label="Create New Work"]').click();
