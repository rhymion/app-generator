...
//
// Mobile-viewport spec (Fc Link). The list page renders a different
...
describe('Testing Fc Link pages and their behavior [mobile]', () => {
  beforeEach(() => {
  ...
  describe('Card list', () => {
    ...
    it('1.2 renders one card per item with the primary value as title', () => {
      ...
      cy.visit('/en/fc_link');
      cy.contains('Fc Link 1').should('be.visible');
