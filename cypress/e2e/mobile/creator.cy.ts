...
//
// Mobile-viewport spec (Creator). The list page renders a different
...
describe('Testing Creator pages and their behavior [mobile]', () => {
  beforeEach(() => {
  ...
  describe('Create from card list', () => {
    it('2.1 navigates to the new page via the toolbar add button', () => {
      ...
      // aria-label as the desktop variant ("Create New Creator").
      cy.get('button[aria-label="Create New Creator"]').click();
