...
export async function populateCreatorDependencies() {
  return {};
}

export async function populateCreatorData(length: number) {
...
export const populateCreatorFullData = populateCreatorData;
