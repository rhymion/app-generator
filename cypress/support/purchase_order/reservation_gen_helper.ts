...
/** (1) Multi-item allocation success: two inventory rows with the same product_id and sufficient stock */
...
/** (2) Insufficient stock rollback: inventory that cannot satisfy the required quantity */
...
/** (3) criteria compliance: mix of inventory with matching and non-matching product_id */
...
/** (4) orderBy compliance: three inventory rows with the same product_id but different orderBy field values */
