// Fixture-only stand-in for @/lib/authz (direct_attachment_gate).
...
// required-one-to-one-selector branch this gate exists to catch. authz.ts's
// own correctness is covered by the main repo's own `test:e2e:build`/tsc
// gate already -- this file exists only so this fixture's call sites
// type-check.
