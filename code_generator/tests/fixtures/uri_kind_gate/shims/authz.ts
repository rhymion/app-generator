// Fixture-only stand-in for @/lib/authz (uri-kind-gate check).
...
// only so the uri-kind-branch call sites type-check. Mirrors
// tests/fixtures/decimal_gate/shims/authz.ts.
