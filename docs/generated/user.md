...
| `sub_accounts` | [`sub_account`](sub_account.md) | one-to-many · `list` |
| `created_works` | [`work`](work.md) | one-to-many · `list` |
| `created_characters` | [`character`](character.md) | one-to-many · `list` |
| `created_scenes` | [`scene`](scene.md) | one-to-many · `list` |
| `created_channels` | [`channel`](channel.md) | one-to-many · `list` |
| `created_musics` | [`music`](music.md) | one-to-many · `list` |
| `created_creators` | [`creator`](creator.md) | one-to-many · `list` |
| `created_plans` | [`plan`](plan.md) | one-to-many · `list` |
...
| `sub_accounts` | `object[]` | `sub_account` child records (all replaced on update) |
